...
urlpatterns = [
    ...
    path("settings/profile/2fa/setup/", views.setup_2fa_view, name="settings_2fa"),
    path("settings/profile/export/", views.export_data_view, name="export_data"),
    path("auth/2fa/", views.verify_2fa_view, name="verify_2fa"),
    path("settings/tenant/", views.tenant_settings_view, name="settings_tenant"),
